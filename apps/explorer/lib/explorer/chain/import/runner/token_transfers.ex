defmodule Explorer.Chain.Import.Runner.TokenTransfers do
  ...
  defp default_on_conflict do
    from(
      ...
      where:
        fragment(
          "(EXCLUDED.amount, EXCLUDED.from_address_hash, EXCLUDED.to_address_hash, EXCLUDED.token_contract_address_hash, EXCLUDED.token_id, EXCLUDED.token_ids) IS DISTINCT FROM (?, ? ,? ,?, ?, ?)",
